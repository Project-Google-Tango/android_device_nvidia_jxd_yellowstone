...
#define IDLE_POLL_PERIOD                400000000 /* nanosecond */
 ...
 */
#define LPA_POLL_PERIOD_THRESHOLD_US    (200000) /* microsecond */
/* HW_MOTION_DETECT_THRESHOLD is a HW specific value.  An understanding of
 * the MPU HW is needed to determine this.  A typical value is 20.
 * A value of 0 disables the feature.
 */
#define HW_MOTION_DETECT_THRESHOLD      (20)
...
public:
    ...
    int setLpaDelay(unsigned long us);
...
protected:
    ...
    int aHandler(sensors_event_t *data);
