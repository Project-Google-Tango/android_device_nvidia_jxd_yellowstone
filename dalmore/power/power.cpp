...
static void dalmore_power_init(struct power_module *module)
{
    int i;
    if (!pInfo)
...
static void dalmore_power_set_interactive(struct power_module *module, int on)
{
    common_power_set_interactive(module, pInfo, on);
}

static void dalmore_power_hint(struct power_module *module, power_hint_t hint,
                            void *data)
{
    common_power_hint(module, pInfo, hint, data);
}

static int dalmore_power_open(const hw_module_t *module, const char *name,
                            hw_device_t **device)
{
...
struct power_module HAL_MODULE_INFO_SYM = {
    ...
    init: dalmore_power_init,
    setInteractive: dalmore_power_set_interactive,
    powerHint: dalmore_power_hint,
};
