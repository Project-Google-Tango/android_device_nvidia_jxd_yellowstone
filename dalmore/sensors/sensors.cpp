...
#define CM3218_SYSFS_PATH "/sys/bus/iio/devices/iio:device0/"
...
sensors_poll_context_t::sensors_poll_context_t()
{
    ...
    mSensors[light] = new Cm3218Light(CM3218_SYSFS_PATH);
    mPollFds[light].fd = -1;
...
int sensors_poll_context_t::pollEvents(sensors_event_t* data, int count)
{
    ...
    do {
        ...
        if (count) {
            ...
            // some events immediately or just wait polltime
