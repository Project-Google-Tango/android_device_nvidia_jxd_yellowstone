...
PRODUCT_NAME := wx_zh_mo
PRODUCT_DEVICE := ardbeg
PRODUCT_MODEL := wx_zh_mo
...
## Non-GMS 3rd-party preinstalled apk
$(call inherit-product-if-exists, 3rdparty/applications/prebuilt/common/wx_zh_mo.mk)

## SKU specific apps
$(call inherit-product-if-exists, vendor/nvidia/ardbeg/wx_zh_mo.mk)
