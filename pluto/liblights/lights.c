                   ...
                   struct light_state_t const *state)
{
    ...
    err = stat("/sys/class/backlight/pwm-backlight/brightness", &buf);
    if (!err)
        file = "/sys/class/backlight/pwm-backlight/brightness";
    else
        file = "/sys/class/backlight/max8831_display_bl/brightness";
